...
#EXT-X-VERSION:7
#EXT-X-INDEPENDENT-SEGMENTS
#EXT-X-MEDIA:TYPE=AUDIO,GROUP-ID="aac",NAME="English",LANGUAGE="en",AUTOSELECT=YES,DEFAULT=YES,URI="layer8.m3u8"
#EXT-X-IMAGE-STREAM-INF:BANDWIDTH=16460,RESOLUTION=240x135,CODECS="jpeg",URI="sd-tn.m3u8"
#EXT-X-IMAGE-STREAM-INF:BANDWIDTH=29729,RESOLUTION=640x360,CODECS="jpeg",URI="hd-tn.m3u8"
'''
